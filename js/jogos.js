...
exports.enigmaArchive = [
  {
    ...
    charada:
      'Imagine que você está em uma sala escura ao lado de Sherlock. Nela há um fósforo, uma lâmpada de querosene, uma vela e uma lareira. O que você acenderia primeiro?',
  },
  {
    numero: 'ENIGMA 2',
    respostaEne: 'SEGREDO',
    charada:
      'O detetive Sherlock encontrou um bilhete que faz parte de uma pista de um mistério que precisa ser solucionado. “Se você me tem, quer me compartilhar; se você não me compartilha, você me manteve. O que eu sou?”',
  },
  {
    numero: 'ENIGMA 3',
    respostaEne: 'NENHUM',
    charada:
      'Watson e Sherlock adoram brincar com enigmas para treinar o método científico. Ajude-os a encontrar a resposta desse enigma: um macaco, um esquilo e um pássaro estão correndo para o topo de um coqueiro. Quem pegará a banana primeiro, o macaco, o esquilo ou o pássaro?',
  },
  {
    numero: 'ENIGMA 4',
    respostaEne: 'ECO',
  ...
  },
  {
    ...
    respostaEne: '12 ANOS',
    charada:
      'Perguntaram para Maria quantos anos ela tem. Maria respondeu que em dois anos terá o dobro da idade que ela tinha há cinco anos. Quantos anos Maria tem?',
  },
  {
    numero: 'ENIGMA 8',
  ...
  },
  {
    ...
    respostaEne: 'ESPONJA',
    charada:
      'Sou cheio de buracos, mas ainda assim consigo reter muita água. Quem sou eu?',
  },
  {
    numero: 'ENIGMA 9',
    respostaEne: 'COTOVELO DIREITO',
    charada:
      'O que você pode segurar com a sua mão esquerda, mas jamais com a direita?',
  },
  {
    numero: 'ENIGMA 10',
    respostaEne: 'ÂNCORA',
    charada:
      'Quando precisa de mim, você me atira para longe, até um lugar onde ninguém pode me ver. Mas quando já não precisa mais, você me traz de volta. Quem sou eu?',
  },
  {
    numero: 'ENIGMA 11',
    respostaEne: 'AS PALAVRAS',
    charada:
      'Nós podemos machucar sem fazer um único movimento. Podemos envenenar sem tocar. Carregamos a verdade e a mentira. E não devemos ser julgadas pelo nosso tamanho Quem somos nós?',
  },
  {
    numero: 'ENIGMA 12',
    respostaEne: 'UMA TESOURA',
    charada:
      'Ponha os dedos nos meus olhos que eu abrirei as minhas potentes mandíbulas. E vou devorar tudo o que vier pela frente: roupas, penas, papéis. Quem sou eu?',
  },
  {
    numero: 'ENIGMA 13',
    respostaEne: 'ALFABETO',
    charada:
      'Eu posso guardar tudo dentro de mim. Tudo o que você pode imaginar: o vento, as florestas, o mundo, o universo e até Deus. Tudo o que vier à sua cabeça você pode encontrar dentro de mim. Quem sou eu?',
  },
  {
    numero: 'ENIGMA 14',
  ...
  },
  {
    ...
    respostaEne: 'JOÃO',
    charada:
      'A mãe do João teve cinco filhos. O primeiro se chamava Dadá, o segundo Dedé, o terceiro, Didi, e o quarto, Dodó. Como se chamava o quinto filho?',
  },
  {
    numero: 'ENIGMA 20',
    respostaEne: 'O CAIXÃO',
    charada:
      'O que é, o que é: quem faz não quer, quem compra não usa e quem usa não fica sabendo?',
  },
];
...
exports.whatMusicAr = [
  ...
  },
  {
    ...
    artista:
      'MC Cabelinho, Luísa Sonza, Oruam, Tz da Coronel, Chefin, L7nnon, Xamã, Chris MC, …',
